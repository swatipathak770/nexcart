...
import com.nexcart.repository.CouponUsageRepository;
...
public class CouponServiceImpl implements CouponService {
    ...
    public ApplyCouponResponse applyCoupon(ApplyCouponRequest request) {
        ...
        Coupon coupon = validateCoupon(request.getCouponCode(), orderAmount, getCurrentUser());
    ...
    public Coupon validateCoupon(String couponCode, BigDecimal orderAmount) {
        ...
        return validateCoupon(couponCode, orderAmount, null);
    }

    @Override
    @Transactional(readOnly = true)
    public Coupon validateCoupon(String couponCode, BigDecimal orderAmount, User user) {
        ...
        if (user != null && couponUsageRepository.existsByCouponAndUser(coupon, user)) {
            throw new InvalidCouponException("This coupon has already been used on your account.");
        }
